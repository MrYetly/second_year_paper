...
\begin{abstract}
We extend both the concept of Lindahl equilibria and Walker's mechanism to attain them. Lindahl's original result optimally allocates resources in an economy with a public good, but it does so without taking into account the distribution of consumer surplus. We show this can lead to unjust outcomes. Our generalized Lindahl equilibrium corrects this issue by giving each consumer a personalized tax schedule. It is Pareto optimal, individually rational, and covers the cost of the public good. We show how our concept could be used to distribute surplus according to preferences embodied in a social welfare function. We also introduce a mechanism capable of attaining generalized Lindahl equilibria when the private valuations of consumers are not known, a generalized Walker mechanism. We prove that any Nash equilibrium of a game induced by a generalized Walker mechanism is a generalized Lindahl equilibria.
\end{abstract}
...
Our generalized Lindahl equilibrium is an improvement on a classical Lindahl equilibrium. The classical result has desirable properties. It is Pareto optimal, individually rational, and covers the cost of providing a public good. But, it can lead to unjust outcomes because it does not take into account the distribution of consumer surplus. A generalized Lindahl equilibrium corrects this shortcoming, and retains all of the desirable features of a classical Lindahl equilibrium. 
