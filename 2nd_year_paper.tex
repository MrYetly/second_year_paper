...
We have shown how a generalized Walker mechanism allows a social planner to attain a generalized Lindahl equilibrium when they do not know the private valuations of consumers. We have proved that any Nash equilibrium of a game induced by this mechanism is a generalized Lindahl allocation. In future research, we would like to prove that any generalized Lindahl allocation is achieved by a unique Nash equilibrium induced by our mechanism.

Lindahl's classical result is a standard by which public goods theories are measured. Our generalization is a better standard, because it is not satisfied by individuals merely being better off: \textit{how} they are better off matters, in relation to themselves and others. This new standard is applicable to any economy concerned with the distribution of surplus; and any economy that is not is potentially unjust.
